...
function sendPacket(src_ip, dst_ip, latency, callback) {
...
// this could be initiate connection
let loadJson = d3.json("http://localhost:8080/binary/nfs_base.json");

loadJson.then(function(success) {
	initializeGraph(initializeData(success));
})
...
function replayPCAP() {
	loadJson.then(function(packets) {
...
function parsePacket(packet) {
	var obj = {"src": null, "dst": null, "time": null}
}
